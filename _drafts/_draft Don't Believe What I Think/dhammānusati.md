...
- [ ] 👆🏼find sutta
	...
	- but the sutta about needing to save oneself from the world, not save the world itself

- [ ] 👇🏼 find sutta, *Buddha, My Refuge*, 7.4 (p. 92)
- Buddha taught dhamma monarchs and held the ideal of the Wheel-turning Monarch, who 'wields power only in a principled manner' ([[AN 5.131 'Wielding Power (1st)']]) still valuable today for heads of government, and related to the Philosopher King 
	- there are five definitions of ways to 'turn the wheel' (p. 92, 7.4, Buddha, My Refuge): 
		- knowledge of good
		- knowledge of dhamma
		- amount
		- occassion
		- assembly
		- Perhaps it's about knowing which dhamma to teach when, and to whom.
	- and five qualities of the way the Buddha 'turns the wheel'